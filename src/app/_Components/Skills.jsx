...
const Skills = () => {
  return (
    <section id="skills" className="min-h-screen w-full pt-[4rem] snap-start">
      {/* Top */}
      ...
      <div className="flex md:justify-between md:flex-row flex-col-reverse mt-10 md:items-start items-center">
        {/* Left */}
        <div className="md:w-[48%] w-10/12 md:my-0 my-10">
          ...
          <div className="flex gap-1">
            <div className="w-32 border-r border-[#0001] md:pl-2 pl-1">
            ...
            <div className="w-32 md:pl-2 pl-1">
